...
public class FootballApiService {
    ...
    public void updateMatches(String competitionCode) {
        try {
            ...
            try {
                Thread.sleep(6000); // Wait 6 seconds between API calls
            ...
            if (response != null && response.has("matches")) {
                ...
                log.info("Retrieved {} matches for competition {}", matches.size(), competitionCode);
    ...
    public void updateTeamPlayers(String teamCode) {
        try {
            ...
            if (response != null && response.has("squad")) {
                ...
                log.info("Retrieved {} players for team {}", squad.size(), teamName);
